...
import org.devio.takephoto.adapters.CustomAlbumSelectAdapter;
import org.devio.takephoto.helpers.Constants;
import org.devio.takephoto.model.Album;
...
public class AlbumSelectActivity extends HelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler=new AlbumWeakHandler(this);
    ...
    private static class AlbumWeakHandler extends Handler {
        private final WeakReference<AlbumSelectActivity> activityWeakReference;

        public AlbumWeakHandler(AlbumSelectActivity activity) {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            AlbumSelectActivity activity = activityWeakReference.get();
            switch (msg.what) {
                ...
                case Constants.FETCH_COMPLETED: {
                    if (activity.adapter == null) {
                        activity.adapter = new CustomAlbumSelectAdapter(activity, activity.albums);
